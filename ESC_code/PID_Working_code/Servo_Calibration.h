...
float roll_mid=17;      //the midpoint where the motor holder is centered
float roll_max=24;      //the max the servo can move
//pitch
float pitch_min=0;      //the minimum the servo can move
float pitch_mid=18;     //the midpoint where the motor holder is centered
float pitch_max=35;     //the max the servo can move
