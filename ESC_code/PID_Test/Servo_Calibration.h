...
float roll_mid=20;      //the midpoint where the motor holder is centered
float roll_max=40;      //the max the servo can move
//pitch
float pitch_min=0;      //the miimum the servo can move
float pitch_mid=20;     //the midpoint where the motor holder is centered
float pitch_max=40;     //the max the servo can move
