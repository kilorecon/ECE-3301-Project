...
//roll  pin 10
float roll_min=78;       //50 the minimum the servo can move
float roll_mid=90;      //the midpoint where the motor holder is centered
float roll_max=102;      //150 the max the servo can move
//pitch pin 9
float pitch_min=70;      //45 the minimum the servo can move
float pitch_mid=90;     //the midpoint where the motor holder is centered
float pitch_max=110;     //135 the max the servo can move
