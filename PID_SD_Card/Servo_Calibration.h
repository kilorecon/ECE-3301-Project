...
float roll_mid=27;      //the midpoint where the motor holder is centered
float roll_max=39;      //the max the servo can move
//pitch pin 9
float pitch_min=3;      //the minimum the servo can move
float pitch_mid=16;     //the midpoint where the motor holder is centered
float pitch_max=30;     //the max the servo can move
